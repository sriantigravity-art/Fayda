...
export const LandingShowcasePage: React.FC<LandingShowcasePageProps> = ({
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors duration-200 select-none overflow-x-hidden">
        ...
        <div className="max-w-[1840px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-5 text-left">
            ...
            <div className="flex items-center space-x-2">
              <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-accent-sky/15 text-accent-sky border border-accent-sky/30 shadow-xs">
                {activeSlide.badge}
              </span>
                  ...
                  <button
                    ...
                    className={`transition-all duration-200 rounded-full cursor-pointer ${
                      currentSlideIndex === idx
                        ? 'w-6 h-1.5 bg-accent-sky shadow-xs'
            ...
            <h1 className={`text-3xl sm:text-5xl lg:text-6xl ${activeSlide.fontStyle} text-slate-900 dark:text-white leading-[1.12]`}>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                type="button"
                onClick={() => scrollToSection('auth-section')}
                className="px-6 py-3.5 rounded-2xl bg-gradient-to-r from-accent-sky via-blue-600 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-extrabold text-sm shadow-lg shadow-sky-500/25 transition cursor-pointer flex items-center gap-2 transform active:scale-95"
              >
              ...
              <button
                type="button"
                onClick={onLaunchDemo}
                className="px-5 py-3.5 rounded-2xl bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold text-sm border border-slate-300 dark:border-slate-700 transition cursor-pointer flex items-center gap-2"
              >
                <Play className="w-4 h-4 text-accent-sky fill-current" />
                <span>{activeSlide.secondaryCtaText}</span>
              </button>
            </div>

            {/* Slider Navigation & Pause Controls */}
            <div className="flex items-center space-x-3 pt-2 text-xs font-mono text-slate-500">
              <div className="flex items-center space-x-1">
                ...
                >
                  {isSlidePaused ? <Play className="w-3.5 h-3.5 text-emerald-500" /> : <Pause className="w-3.5 h-3.5" />}
                </button>
                <button
                  type="button"
          ...
          {/* RIGHT SIDE: ANIMATED INTERACTIVE MOCK TERMINAL PREVIEW CARD */}
          <div className="lg:col-span-5 relative">
            <div className="p-4 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl backdrop-blur-xl relative z-10 space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                ...
                <span className="px-2 py-0.5 rounded-md text-[10px] font-mono font-black uppercase bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30">
                  BUY CALL (CE)
                </span>
              </div>
              ...
              <div className="flex items-baseline justify-between">
                ...
                <div className="text-right">
                  <div className="text-xs text-slate-500 font-mono">Confluence Score</div>
              ...
              <div className="grid grid-cols-3 gap-2 p-3 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800/80 font-mono text-center">
                <div>
                  <div className="text-[10px] text-slate-400 font-bold uppercase">Buy Range</div>
                  <div className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white">₹116 - ₹122</div>
                </div>
                <div>
                  <div className="text-[10px] text-emerald-500 font-bold uppercase">Target 1 & 2</div>
                  <div className="text-xs sm:text-sm font-bold text-emerald-600 dark:text-emerald-400">₹158 / ₹195</div>
                </div>
                <div>
                  <div className="text-[10px] text-rose-500 font-bold uppercase">Stop-Loss</div>
                  <div className="text-xs sm:text-sm font-bold text-rose-600 dark:text-rose-400">₹94.00</div>
                </div>
              </div>
      ...
      {/* ========================================================================= */}
      <section id="track-record-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-[1840px] mx-auto w-full">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-10">
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-center">
            <div className="text-2xl sm:text-4xl font-black font-mono text-emerald-500">
              {cmsData.performanceStats.winRatePct}%
            </div>
            <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Verified Win Ratio</div>
            <div className="text-[10px] text-slate-500 font-mono">Across {cmsData.performanceStats.totalSetupsLogged}+ Curated Trades</div>
          </div>

          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-center">
            <div className="text-2xl sm:text-4xl font-black font-mono text-accent-sky">
              {cmsData.performanceStats.averageRiskReward}
            </div>
            <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Average Risk : Reward</div>
            <div className="text-[10px] text-slate-500 font-mono">Strict 1:2 Minimum Mandate</div>
          </div>

          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-center">
            <div className="text-2xl sm:text-4xl font-black font-mono text-purple-500">
              +{cmsData.performanceStats.alphaVsNiftyPct}%
            </div>
            <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Alpha Outperformance</div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-center">
            ...
            <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Dual-Tier WS Latency</div>
            <div className="text-[10px] text-slate-500 font-mono">Real-Time Fyers & Dhan Feed</div>
          </div>
        </div>

        {/* Filterable Closed Trades Ledger Table */}
        <div className="p-4 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden space-y-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
            <div>
              ...
              <p className="text-xs text-slate-500 font-mono">Logged time-stamps with exact entry, exit, and realized P&L</p>
            </div>
              ...
              {(['ALL', 'NIFTY', 'BANKNIFTY', 'SENSEX', 'MCX'] as const).map(f => (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg font-bold transition cursor-pointer border ${
                    tradeFilter === f
                      ? 'bg-accent-sky text-slate-950 border-accent-sky'
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
                {filteredTrades.map(trade => (
                  <tr key={trade.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition">
                    <td className="py-3 px-3 text-slate-500 font-medium">{trade.date}</td>
                    <td className="py-3 px-3 font-bold text-slate-900 dark:text-white">{trade.strike}</td>
                    ...
                    <td className="py-3 px-3 text-slate-700 dark:text-slate-300">₹{trade.entry.toFixed(2)}</td>
                    <td className="py-3 px-3 font-bold text-slate-900 dark:text-white">₹{trade.exit.toFixed(2)}</td>
                    <td className="py-3 px-3">
                      <span className={`font-bold ${trade.pnlPct >= 0 ? 'text-emerald-500' : 'text-rose-500'}`}>
      ...
      {/* ========================================================================= */}
      <section id="features-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-[1840px] mx-auto w-full border-t border-slate-200 dark:border-slate-800">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-accent-sky/15 text-accent-sky border border-accent-sky/30">
            SYSTEM ARCHITECTURE
          </span>
          <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cmsData.features.map(feat => (
            <div
              key={feat.id}
              className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between group"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-mono font-black uppercase px-2.5 py-0.5 rounded-full bg-accent-sky/15 text-accent-sky border border-accent-sky/30">
                    {feat.badge}
                  </span>
                  <Sparkles className="w-4 h-4 text-accent-sky opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
              ...
              <div className="pt-5 mt-5 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between">
                <span className="text-[11px] font-mono text-slate-400">
                  {feat.tagline.slice(0, 32)}...
                </span>

                <button
                  type="button"
                  onClick={() => setSelectedFeature(feat)}
                  className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-accent-sky hover:text-sky-400 transition cursor-pointer"
                >
      ...
      {/* ========================================================================= */}
      <section className="py-14 sm:py-20 px-4 sm:px-6 max-w-[1840px] mx-auto w-full border-t border-slate-200 dark:border-slate-800">
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-purple-500/15 text-purple-600 dark:text-purple-400 border border-purple-500/30">
            THE SYSTEMATIC EDGE
          </span>
          <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white tracking-tight">
        ...
        <div className="p-4 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-x-auto no-scrollbar">
          <table className="w-full text-left text-xs font-sans min-w-[640px]">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 text-[11px] font-mono uppercase text-slate-400">
                <th className="py-3 px-4 w-1/4">Trading Dimension</th>
                <th className="py-3 px-4 w-3/8 text-rose-500">Retail Trader (Guesswork)</th>
                <th className="py-3 px-4 w-3/8 text-emerald-500">Fayda PRO (Institutional Edge)</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-medium">
              {[
                ...
                <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                  <td className="py-3.5 px-4 font-mono font-bold text-slate-900 dark:text-white">{row.dim}</td>
                  <td className="py-3.5 px-4 text-slate-500 dark:text-slate-400">{row.bad}</td>
                  <td className="py-3.5 px-4 font-semibold text-emerald-600 dark:text-emerald-400">{row.good}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* ========================================================================= */}
      <section id="pricing-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-[1840px] mx-auto w-full border-t border-slate-200 dark:border-slate-800">
        
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <span className="text-[10px] font-mono font-black uppercase px-2 py-0.5 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300">
                  EXPLORER
                </span>
                <h3 className="text-xl font-black text-slate-900 dark:text-white mt-1">7-Day Free Trial</h3>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Real-time Paper Trading Simulator</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Basic Spot Indices Quotes</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Daily Pre-Market CPR Range</li>
                <li className="flex items-center gap-2 text-slate-400 dark:text-slate-600"><X className="w-4 h-4 shrink-0" /> 10-Factor Confluence Signals</li>
              </ul>
            </div>
            <button
              type="button"
              onClick={() => scrollToSection('auth-section')}
              className="mt-6 w-full py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 font-bold text-xs text-slate-900 dark:text-white transition cursor-pointer"
            >
              Start Free Trial
            </button>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <span className="text-[10px] font-mono font-black uppercase px-2 py-0.5 rounded-full bg-sky-500/20 text-sky-600 dark:text-sky-400">
                  DERIVATIVES CORE
                </span>
                <h3 className="text-xl font-black text-slate-900 dark:text-white mt-1">Silver Plan</h3>
                <div className="text-3xl font-black font-mono text-slate-900 dark:text-white mt-2">
                  ₹999 <span className="text-xs font-normal text-slate-500">/ month</span>
                </div>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Live OI Surge Alerts (NSE & BSE)</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> High-Density Option Chain Heatmap</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Global Macro Risk Context Ribbon</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Position Size & Risk Calculator</li>
              </ul>
            </div>
            <button
              type="button"
              onClick={() => scrollToSection('auth-section')}
              className="mt-6 w-full py-2.5 rounded-xl bg-sky-500 hover:bg-sky-400 font-bold text-xs text-slate-950 transition cursor-pointer"
            >
              Get Silver
            </button>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-b from-sky-500/10 via-white to-white dark:from-sky-500/15 dark:via-slate-900 dark:to-slate-900 border-2 border-accent-sky shadow-2xl flex flex-col justify-between relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-accent-sky text-slate-950 text-[10px] font-mono font-black uppercase shadow-sm">
              MOST POPULAR
            </div>
            <div className="space-y-4">
              <div>
                <span className="text-[10px] font-mono font-black uppercase px-2 py-0.5 rounded-full bg-accent-sky/20 text-accent-sky">
                  INSTITUTIONAL ALPHA
                </span>
                <h3 className="text-xl font-black text-slate-900 dark:text-white mt-1">Gold Plan</h3>
                <div className="text-3xl font-black font-mono text-slate-900 dark:text-white mt-2">
                  ₹2,499 <span className="text-xs font-normal text-slate-500">/ month</span>
                </div>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> 10-Factor Confluence Signal Cockpit</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Inline Strike Candlestick Workbench</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> 1-Click Fyers & Dhan Live Execution</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Instant Real-Time Voice Alerts</li>
              </ul>
            </div>
            <button
              type="button"
              onClick={() => scrollToSection('auth-section')}
              className="mt-6 w-full py-2.5 rounded-xl bg-gradient-to-r from-accent-sky to-blue-600 hover:from-sky-400 hover:to-blue-500 font-extrabold text-xs text-white shadow-md transition cursor-pointer"
            >
              Get Gold Pro
            </button>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <span className="text-[10px] font-mono font-black uppercase px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-600 dark:text-purple-400">
                  HEDGE FUND VIP
                </span>
                <h3 className="text-xl font-black text-slate-900 dark:text-white mt-1">Diamond Plan</h3>
                <div className="text-3xl font-black font-mono text-slate-900 dark:text-white mt-2">
                  ₹4,999 <span className="text-xs font-normal text-slate-500">/ month</span>
                </div>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> All Gold Features Included</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Multi-Leg Options Payoff Simulator</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Super Admin Direct API Priority</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Weekly Live Mentorship & Strategy Review</li>
              </ul>
            </div>
            <button
              type="button"
              onClick={() => scrollToSection('auth-section')}
              className="mt-6 w-full py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 font-bold text-xs text-white transition cursor-pointer"
            >
              Get Diamond
            </button>
          </div>
      ...
      {/* ========================================================================= */}
      <section id="auth-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-xl mx-auto w-full">
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl backdrop-blur-xl">
          
          <div className="text-center space-y-2 mb-6">
            <span className="text-[10px] font-mono font-black uppercase px-2.5 py-0.5 rounded-full bg-accent-sky/15 text-accent-sky">
          ...
          {/* Auth Tabs */}
          <div className="grid grid-cols-2 p-1 rounded-2xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 mb-5 text-xs font-mono font-bold">
            <button
              type="button"
          ...
          {authError && (
            <div className="p-3 mb-4 rounded-xl bg-rose-500/15 border border-rose-500/30 text-rose-600 dark:text-rose-400 text-xs font-mono">
              {authError}
            </div>
          )}
          ...
          {authTab === 'SIGN_IN' ? (
            <form onSubmit={handleSignIn} className="space-y-3.5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky font-mono"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky font-mono"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-accent-sky to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-extrabold text-xs shadow-md shadow-sky-500/20 transition cursor-pointer disabled:opacity-50"
              >
              ...
              <div className="pt-2 text-center">
                <button
                  ...
                  className="text-[11px] font-mono text-accent-sky hover:underline cursor-pointer"
                >
            ...
            <form onSubmit={handleSignUp} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky font-mono"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isAuthLoading}
                className="w-full py-3 rounded-xl bg-accent-sky hover:bg-sky-400 text-slate-950 font-extrabold text-xs shadow-md transition cursor-pointer disabled:opacity-50"
              >
          ...
          <div className="pt-4 mt-4 border-t border-slate-100 dark:border-slate-800 text-center">
            <button
              type="button"
              onClick={onLaunchDemo}
              className="text-xs font-mono font-bold text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition cursor-pointer"
            >
      ...
      {/* ========================================================================= */}
      <section id="contact-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-[1840px] mx-auto w-full border-t border-slate-200 dark:border-slate-800">
        
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono font-black uppercase tracking-wider bg-sky-500/15 text-sky-600 dark:text-sky-400 border border-sky-500/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md space-y-4">
              ...
              <div className="space-y-3 text-xs text-slate-600 dark:text-slate-300 font-sans">
                <div className="flex items-start gap-3">
                  <Globe className="w-4 h-4 text-accent-sky shrink-0 mt-0.5" />
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800 text-[11px] font-mono text-slate-400">
                {cmsData.contactInfo.sebiRegistrationNumber}
              </div>
            </div>

            {/* Quick WhatsApp Assistance Card */}
            <div className="p-5 rounded-3xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-between">
              <div>
              ...
              <a
                ...
                className="px-3.5 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs shadow-sm transition"
              >
                Chat Now
              </a>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl">
              ...
              {contactSubmitted ? (
                <div className="p-6 rounded-2xl bg-emerald-500/15 border border-emerald-500/40 text-center space-y-2 animate-in zoom-in-95">
                  <CheckCircle2 className="w-8 h-8 text-emerald-500 mx-auto" />
                  <h4 className="text-sm font-bold text-emerald-600 dark:text-emerald-400 font-mono">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4 text-xs font-sans">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky font-mono"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:outline-none focus:border-accent-sky leading-relaxed"
                    />
                  </div>

                  <button
                    type="submit"
                    className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-accent-sky to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-bold text-xs shadow-md transition cursor-pointer"
                  >
      ...
      {/* ========================================================================= */}
      <section id="faq-section" className="py-14 sm:py-20 px-4 sm:px-6 max-w-4xl mx-auto w-full border-t border-slate-200 dark:border-slate-800">
