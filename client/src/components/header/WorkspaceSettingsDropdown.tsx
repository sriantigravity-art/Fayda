...
export const WorkspaceSettingsDropdown: React.FC<WorkspaceSettingsDropdownProps> = ({
  ...
  return (
    <div className="relative inline-block" ref={dropdownRef}>
      ...
      {/* Flyout Menu */}
      {isOpen && (
        <div className={`absolute right-0 mt-2 w-[calc(100vw-1.5rem)] sm:w-80 max-w-sm rounded-2xl shadow-2xl p-3 z-[9999] animate-in fade-in slide-in-from-top-2 duration-150 border backdrop-blur-xl ${
          isDark
