export class MarketRegimeEngine {
     ...
     */
    static evaluateRegime(symbol, spotPrice, cpr, openPrice, dayHigh, dayLow) {
        ...
        const isReversalDay = cpr.cprWidthCategory === 'WIDE_CPR' && ((high > cpr.pdh && spotPrice < cpr.pdh) ||
