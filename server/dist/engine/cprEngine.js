...
export class CPREngine {
     ...
     */
    static calculateCPR(symbol, spotPrice, high, low, close) {
        ...
        let cprWidthCategory = 'AVERAGE_CPR';
        let expectedDayType = 'AVERAGE_DAY';
     ...
     */
    static getVirginCPRs(symbol, currentSpot) {
