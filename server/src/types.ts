...
export type TradeCallStatus =
  ...
  | 'CARRIED_FORWARD';   // Overnight carry forward from previous trading day
...
export interface JournalTradeCall {
  ...
  troughLtp?: number; // Lowest price reached
  exitLtp?: number; // Price when booked or closed
  ...
  nearTargetDescription?: string; // '100% Hit' or 'Reached 94% of Target'
  // Timing Milestones
