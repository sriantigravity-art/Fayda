import { 
  CompanyGlobalExposure, 
  GlobalTransmissionPath, 
  NewsLayeredScores, 
  NewsImpactStamp, 
  GlobalEventCategory, 
  GlobalRiskMode 
...
export const COMPANY_EXPOSURE_DATABASE: Record<string, CompanyGlobalExposure> = {
  'TCS': {
    symbol: 'TCS',
...
export class GlobalGeopoliticalEngine {
  ...
  public analyzeNews(
    title: string,
    desc: string,
    currentRiskMode: GlobalRiskMode = 'NEUTRAL'
   ...
   */
  private analyzeTrumpTariffPolicy(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    let impactStamp: NewsImpactStamp = isRelief ? 'POSITIVE' : isPharma ? 'NEUTRAL' : 'NEGATIVE';
   ...
   */
  private analyzeH1bAndTechWorkload(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    let impactStamp: NewsImpactStamp = 'NEGATIVE';
   ...
   */
  private analyzeCrudeCommodity(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    const impactStamp: NewsImpactStamp = isPositiveForIndia ? 'POSITIVE' : 'NEGATIVE';
   ...
   */
  private analyzeFedAndGlobalMacro(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    const impactStamp: NewsImpactStamp = isPositive ? 'POSITIVE' : 'NEGATIVE';
   ...
   */
  private analyzeGeopoliticalWar(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
   ...
   * 6. CHINA STIMULUS & INDUSTRIAL POLICY ENGINE
   */
  private analyzeChinaStimulus(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    const impactStamp: NewsImpactStamp = isStimulus ? 'POSITIVE' : 'NEUTRAL';
   ...
   */
  private analyzeFiiCapitalFlows(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
   ...
   * 8. RBI & DOMESTIC MONETARY POLICY
   */
  private analyzeRbiMonetaryPolicy(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    const impactStamp: NewsImpactStamp = isBull ? 'POSITIVE' : 'NEGATIVE';
   ...
   */
  private analyzeGenericDomesticNews(title: string, desc: string, text: string, riskMode: GlobalRiskMode): GlobalAnalysisResult {
    ...
    const impactStamp: NewsImpactStamp = isPositive ? 'POSITIVE' : isNegative ? 'NEGATIVE' : 'NEUTRAL';
