...
export class PatternEngine {
   ...
   */
  public static calculateMTFLevels(symbol: IndexSymbol, spotPrice: number): MultiTimeframeLevel[] {
   ...
   */
  public static analyzePatternAndBreakout(
    symbol: IndexSymbol,
    spotPrice: number,
    ...
    let status: 'FORMING' | 'TESTING_NECKLINE' | 'CONFIRMED_BREAKOUT' | 'FAILED_TRAP' = 'TESTING_NECKLINE';
    let direction: 'UPWARD_BREAKOUT' | 'DOWNWARD_BREAKDOWN' | 'RANGEBOUND' = 'UPWARD_BREAKOUT';
    let confidence = 86;
    ...
    let revOrCont: 'BULLISH_REVERSAL' | 'BEARISH_REVERSAL' | 'BULLISH_CONTINUATION' | 'BEARISH_CONTINUATION' | 'RANGE_EXPANSION' = 'BULLISH_CONTINUATION';
    ...
    let callWritingPressure: 'HEAVY' | 'MODERATE' | 'UNWINDING' = 'MODERATE';
    let putSupportPressure: 'HEAVY' | 'MODERATE' | 'UNWINDING' = 'MODERATE';
