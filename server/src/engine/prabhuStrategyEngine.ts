...
export type PrabhuStrategyId =
  // 9 Trending Strategies (Chapter 7)
  | 'OD_PATTERN'
  | 'MORNING_STAR'
  | 'EVENING_STAR'
  | 'CPRBO_PATTERN'
  ...
  | 'GAP_FILLING'
  | 'EMA_TREND_FOLLOWING'
  // 5 Sideways Strategies (Chapter 8)
  | 'PPT_PATTERN'
  | 'GCR_PATTERN'
  | 'RCR_PATTERN'
  | 'M_PATTERN'
  | 'W_PATTERN'
  // 11 Reversal Strategies (Chapter 9)
  | 'ODR_PATTERN'
  | 'GCBO_PATTERN'
  | 'RCBO_PATTERN'
  | 'VIRGIN_CPR_REVERSAL'
