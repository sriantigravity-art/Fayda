import { BuildupType, OptionType, TradeAction, IndexSymbol } from '../types.js';

export function classifyBuildup(oiDelta: number, priceDelta: number): BuildupType {
  if (oiDelta >= 0) {
...
export function generateOptionSuggestion(
  symbol: IndexSymbol,
  strike: number,
  optionType: OptionType,
  ltp: number,
